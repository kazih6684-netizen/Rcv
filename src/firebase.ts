...
import { getFirestore, collection, addDoc, getDocs, deleteDoc, doc, query, orderBy, onSnapshot, updateDoc } from 'firebase/firestore';
...
export { app, db, collection, addDoc, getDocs, deleteDoc, doc, query, orderBy, onSnapshot, updateDoc };
